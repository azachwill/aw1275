window.WsalAs = ( function() {
	...
	o.Attach( function() {
		...
		jQuery( '#wsal_as_widget_username, #wsal_as_widget_firstname, #wsal_as_widget_lastname, #wsal_as_widget_postid, #wsal_as_widget_postname, .wsal_as_filters_datewidget' ).keypress(
			function( event ) {
				if ( 13 === event.which ) {
