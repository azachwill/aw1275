...
namespace WSAL_Vendor\Psr\Log\Test;

use WSAL_Vendor\Psr\Log\LoggerInterface;
use WSAL_Vendor\Psr\Log\LogLevel;
use WSAL_Vendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('WSAL_Vendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('WSAL_Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('WSAL_Vendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
