...
use WSAL_Vendor\Twilio\Exceptions\ConfigurationException;
use WSAL_Vendor\Twilio\Exceptions\TwilioException;
use WSAL_Vendor\Twilio\Http\Client as HttpClient;
use WSAL_Vendor\Twilio\Http\CurlClient;
use WSAL_Vendor\Twilio\Security\RequestValidator;
use WSAL_Vendor\Twilio\VersionInfo;
/**
...
class Client
{
     ...
     */
    public function request(string $method, string $uri, array $params = [], array $data = [], array $headers = [], string $username = null, string $password = null, int $timeout = null) : \WSAL_Vendor\Twilio\Http\Response
    {
     ...
     */
    public function getAccount() : \WSAL_Vendor\Twilio\Rest\Api\V2010\AccountContext
    {
     ...
     */
    protected function contextAddresses(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AddressContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextApplications(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ApplicationContext
    {
     ...
     */
    protected function contextAuthorizedConnectApps(string $connectAppSid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AuthorizedConnectAppContext
    {
     ...
     */
    protected function contextAvailablePhoneNumbers(string $countryCode) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\AvailablePhoneNumberCountryContext
    {
     ...
     */
    protected function contextCalls(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\CallContext
    {
     ...
     */
    protected function contextConferences(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ConferenceContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextConnectApps(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ConnectAppContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextIncomingPhoneNumbers(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\IncomingPhoneNumberContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextKeys(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\KeyContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextMessages(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\MessageContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextNotifications(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\NotificationContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextOutgoingCallerIds(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\OutgoingCallerIdContext
    {
     ...
     * @param string $sid The unique string that identifies this resource
     */
    protected function contextQueues(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\QueueContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextRecordings(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\RecordingContext
    {
     ...
     */
    protected function contextSigningKeys(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\SigningKeyContext
    {
     ...
     * @param string $sid The unique string that identifies this resource
     */
    protected function contextShortCodes(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\ShortCodeContext
    {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextTranscriptions(string $sid) : \WSAL_Vendor\Twilio\Rest\Api\V2010\Account\TranscriptionContext
    {
