...
use WSAL_Vendor\Twilio\Rest\Media\V1;
/**
...
class Media extends Domain
{
    ...
    protected function getMediaProcessor() : \WSAL_Vendor\Twilio\Rest\Media\V1\MediaProcessorList
    {
     ...
     */
    protected function contextMediaProcessor(string $sid) : \WSAL_Vendor\Twilio\Rest\Media\V1\MediaProcessorContext
    {
        return $this->v1->mediaProcessor($sid);
    }
    protected function getPlayerStreamer() : \WSAL_Vendor\Twilio\Rest\Media\V1\PlayerStreamerList
    {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextPlayerStreamer(string $sid) : \WSAL_Vendor\Twilio\Rest\Media\V1\PlayerStreamerContext
    {
