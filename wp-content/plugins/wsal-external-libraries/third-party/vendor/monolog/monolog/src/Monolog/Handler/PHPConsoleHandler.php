...
use WSAL_Vendor\PhpConsole\Connector;
use WSAL_Vendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use WSAL_Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('WSAL_Vendor\\PhpConsole\\Connector')) {
