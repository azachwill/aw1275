...
use WSAL_Vendor\GuzzleHttp\Cookie\CookieJar;
use WSAL_Vendor\GuzzleHttp\Exception\GuzzleException;
use WSAL_Vendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \WSAL_Vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
