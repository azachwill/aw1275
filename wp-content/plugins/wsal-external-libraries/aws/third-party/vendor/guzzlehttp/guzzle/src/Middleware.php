...
use WSAL_Vendor\GuzzleHttp\Cookie\CookieJarInterface;
...
use WSAL_Vendor\Psr\Log\LoggerInterface;
/**
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('WSAL_Vendor\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
