	...
	public function display_admin_notice() {
		...
		<div id="sp-wptabs-review-notice" class="sp-wptabs-review-notice">
			...
			<div class="sp-wptabs-notice-text">
				...
				<p>Hope that you had a good experience with the <strong>WP Tabs</strong>. Would you please show us a little love by rating us in the <a href="https://wordpress.org/support/plugin/wp-expand-tabs-free/reviews/?filter=5#new-post" target="_blank"><strong>WordPress.org</strong></a>?
				Just a minute to rate the plugin. Thank you!</p>

				<p class="sp-wptabs-review-actions">
					<a href="https://wordpress.org/support/plugin/wp-expand-tabs-free/reviews/?filter=5#new-post" target="_blank" class="button button-primary notice-dismissed rate-wp-tabs">Ok, you deserve it</a>
