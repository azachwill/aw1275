        ...
        <div class="grid grid-cols-12 gap-x-4">
            <div class="col-span-12 lg:col-span-5">
                ...
                <div class="flex flex-col md:flex-row mt-[40px]">
                    <a href="https://posit.co/blog/using-r-in-production-with-posit-connect/" role="button" target="_self" rel="" class="btn btn-md-primary mb-[16px] last-of-type:mb-0 md:mb-0 md:mr-[16px] md:last-of-type:mr-0" aria-label="Join Posit Academy">
                        See Blog Post
                    </a>
                </div>
